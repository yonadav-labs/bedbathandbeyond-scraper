...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "bedbathandbeyond_site.settings")
django.setup()

from product.models import *
from product.views import *

class BedbathandbeyondSpider(scrapy.Spider):
    name = "bedbathandbeyond"

    custom_settings = {
        'USER_AGENT': 'bedbathandbeyond_scraper (+http://www.yourdomain.com)',
    }
    ...
    def store_report(self):
        ...
        path = '/home/exports/bedbathandbeyond-{}-{}.csv'.format(self.task.title, date)
